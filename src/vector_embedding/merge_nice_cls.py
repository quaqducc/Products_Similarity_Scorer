...
def split_heading_and_note(meta_goods_and_services: str) -> tuple[str, str]:
    # Pattern: "Class Heading ... Explanatory Note ..."
    ...
    if match:
        ...
        note = ""
    # Remove optional leading label "Class Heading"
...
def main():
    ...
    # Gather files group_1.json .. group_45.json (sort numerically)
    ...
    for p in paths:
        try:
            ...
            raise RuntimeError(f"Failed to process {p}: {e}")
